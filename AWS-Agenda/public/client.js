...
function msgToDiv (msg)
{
    for (let i=0; i<msg.length; ++i)
    {
        ...
        let $div = $(
            ...
            "<img   class='block' src='" + msg[i].photo +"'>" +
            "<label class='block'> Name:    " + msg[i].user.name      + "</label>" +
            "<label class='block'> Nick:    " + msg[i].user.nick      + "</label>" +
            "<label class='block'> E-mail:  " + msg[i].user.email     + "</label>" +
            "<label class='block'> Phone:   " + msg[i].user.phone     + "</label>" +
            "<label class='block'> Birthday:" + msg[i].user.birthday  + "</label>" +
            "</div>"
        );
        results.append($div);
    }
